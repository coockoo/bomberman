...
function Router () {
    ...
    this.socket.on('remove block', this.removeBlock.bind(this))
...
Router.prototype.removeBlock = function (block) {
    var blockObj = JSON.parse(block);
    this.gameController.removeBlock(blockObj);
};
